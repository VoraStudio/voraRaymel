document.addEventListener("DOMContentLoaded", () => {
  ...
  tlHero
    ...
    .from(titolHero.chars, { 
      ...
      duration: 1.2, 
      ease: "power4.out",
      onComplete: () => cleanup(document.querySelector(".hero__title"))
    }, "-=0.3")
    .from(".hero__img", { 
      y: -200,
      scale: 0.2, 
      ...
      onComplete: () => cleanup(document.querySelector(".hero__img"))
    }, "-=1.2")
    .from(".hero__scroll-indicator", { opacity: 0, duration: DURATION.NORMAL }, "-=0.8");
  
  gsap.set(".hero__img", { y: 100 });
  ...
  gsap.to(":root", {
    "--porcenatge-titol-Hero": "80%",
    "--porcenatge2-titol-Hero": "100%",
    duration: 2,
    repeat: -1,
    yoyo: true,
    ease: "sine.inOut"
  ...
  if (document.getElementById("morph-svg")) {
    ...
    tlMorph
      .to("#maduixa", { morphSVG: "#ossets" })
      .to("#maduixa", { morphSVG: "#icone" })
      .to("#maduixa", { morphSVG: "#fruites" })
      .to("#maduixa", { morphSVG: "#perles" })
      .to("#maduixa", { morphSVG: "#fulles" })
      .to("#maduixa", { morphSVG: "#maduixa" });
  }

  const frontalSelectors = ".especial > .special-col1 .especial__title, .especial > .special-col2 .especial__text, .especial > .special-col2 .especial__p";
  ...
  specialTL
    ...
    .from(".especial > .special-col1 .especial__img", {
      scale: 0,
      opacity: 0,
      duration: 0.8,
      ease: "back.out(1.7)"
...
// ============================  ITEM  ======================================
    ...
    mm.add("(min-width: 768px)", () => {
      ...
      .from(".Guixos .boxImgItems img", { rotationY: 660, autoAlpha: 0, scale: 0.2, duration: 1.5},"<0.1")
      .to( {}, { duration:1 })
      ...
      .from(".Ossets .boxImgItems img", { rotationY: 620, autoAlpha: 0, scale: 0.2, duration:2},"<0.2")
      ...
      .from(".Perles .boxImgItems img", { rotationY: 620, autoAlpha: 0, scale: 0.2, duration:2},"<0.2")
      ...
      .from(".Fruites .boxImgItems img", { rotationY: 620, autoAlpha: 0, scale: 0.2, duration:2},"<0.2")
      ...
      .from(".Fulles .boxImgItems img", { rotationY: 620, autoAlpha: 0, scale: 0.2, duration:2},"<0.2")
      ...
      .from(".Coles .boxImgItems img", { rotationY: 620, autoAlpha: 0, scale: 0.2, duration:2},"<0.2")
      ...
      .from(".Maduixes .boxImgItems img", { rotationY: 620, autoAlpha: 0, scale: 0.2, duration:2},"<0.2")
      ...
      .from(".Pols .boxImgItems img", { rotationY: 620, autoAlpha: 0, scale: 0.2, duration:2},"<0.2")
      ...
      function updateLayers() {
        layers.forEach((layer, index) => {
          if (index + 1 === currentLayer) {
            ...
            gsap.to(layer, { autoAlpha: 0, duration: 0.5, onComplete: () => {
   ...
   // ============================  PARLEM  ======================================
      ...
      tlparlem.from(parlem.chars, {yPercent: 100, stagger: 0.05, duration: 0.7})
